...
const RESTAURANTS: Prisma.RestaurantCreateInput[] = [
  {
    ...
    isActive: true,
    isFeatured: true,
    tags: ['quick', 'vegetarian-friendly', 'cheap'],
    ratingScore: 8.6,
    averageCalories: 650,
  },
  {
    ...
    isActive: true,
    isFeatured: true,
    tags: ['comfort', 'high-protein', 'date-night'],
    ratingScore: 8.9,
    averageCalories: 900,
  },
  {
  ...
  },
  {
    ...
    isActive: true,
    tags: ['cheap', 'comfort', 'late-night', 'high-protein'],
    ratingScore: 8.8,
    averageCalories: 800,
  },
  {
    ...
    isActive: true,
    tags: ['comfort', 'date-night', 'vegetarian-friendly'],
    ratingScore: 8.3,
    averageCalories: 700,
  },
  {
  ...
  },
  {
    ...
    isActive: true,
    tags: ['comfort', 'quick', 'vegetarian-friendly'],
    ratingScore: 8.2,
  ...
  },
  {
    ...
    isActive: true,
    tags: ['cheap', 'late-night', 'quick', 'vegetarian-friendly'],
    ratingScore: 8.6,
    averageCalories: 650,
  },
]
